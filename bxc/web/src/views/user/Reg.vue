<template lang="pug">
    div
        ...
        van-cell-group(style="border:1px solid #ebedf0;border-radius:5px;margin:15px;padding:5px;" title="注册帐号")
            van-field(label="手机号" type="number" maxlength="11" require label-width="60" left-icon="phone" placeholder="请输入手机号" v-model="phone")
            van-field(label="密码" require label-width="60" left-icon="browsing-history" placeholder="请输入密码" type="password" v-model="password")            
            van-field(label="确认密码" require label-width="60" left-icon="browsing-history" placeholder="请确认密码" type="password" v-model="password2") 
        ...
        van-row
            van-col(offset="8" span="8")
                a(href="/#/login" class="bxc-link") 去登录 
